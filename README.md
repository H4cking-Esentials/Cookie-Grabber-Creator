...
- Added a much easier and more straightforward creation system.
...
- Fixed bug where Discord would crash or the computer would bluescreen (Due to overload with Discord API).
...
-  Bookmark
 ...
 - Chrome, Edge, Brave, Opera GX, and many more...
  - Discord injection
 - Send token, password, and email on login or when the password is changed
 - System info
 - User
 - System
 - Disk
